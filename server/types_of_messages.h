...
namespace CookBook
{
    namespace network
    {
        ...
        //---------------------------------
        /** A request message that is used to store data that should be used to send message which is used to
          ask for lists of available receipts**/
        ...
        /** A request message that is used to send a receipt id to recieve a receipt**/
        ...
        /**A response message that is used to store data of receipts available for downloading. Eeach entry is pair of ID and receipts name **/
        class response_message_1 
        {
        public:
            response_message_1()
            {
        ...
        /**A response message that is used to store data of the particular receipts.
         *  Consist of 8byte type fiels, 8byte size of text file, and 8byte size of image.
         *  Then text of the receipt and bytes of the image **/
